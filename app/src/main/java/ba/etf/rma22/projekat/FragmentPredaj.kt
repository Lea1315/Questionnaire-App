 ...
 * Use the [FragmentPredaj.newInstance] factory method to
...
class FragmentPredaj : Fragment() {
    ...
    private lateinit var predajaHandler: PredajaListener
    ...
    override fun onAttach(context: Context) {
        ...
        predajaHandler = context as PredajaListener
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        progresAnkete.text = predajaHandler.updateProgres()+"%"
        val dugmePredaj = view.findViewById<Button>(R.id.dugmePredaj)
        dugmePredaj.setOnClickListener { predajaHandler.predajAnketu() }
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentPredaj.
         */
